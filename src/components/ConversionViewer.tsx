...
import { Edit, Save, X, ArrowLeft, ArrowRight, Sparkles, Maximize2, Minimize2 } from 'lucide-react';
    ...
    <>
      ...
      <div className="flex items-center justify-between gap-2 mb-4">
        <div className="flex items-center gap-2">
          ...
          {/* Reviewed/Unreviewed Tag */}
          <Badge variant={file.status === 'reviewed' ? 'default' : 'secondary'}>
            {file.status === 'reviewed' ? 'Reviewed' : 'Unreviewed'}
          </Badge>
        </div>
        <div className="flex items-center gap-2">
          {/* Download Button */}
      ...
      {/* Tabs and main content (no duplicate header) */}
      ...
      {/* Full Screen Overlay */}
      {isFullScreen && (
        <div className="fixed inset-0 z-50 bg-white dark:bg-[#18181b] flex flex-col">
          <div className="flex items-center justify-between px-4 py-2 border-b bg-white dark:bg-[#18181b] dark:border-gray-700">
